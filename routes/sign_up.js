...
router.post('/create', function(req, res, next) {
    ...
    var randSortCode = getRandomNumberInString(11111,9999);
    var randomSortCode = getRandomNumberInString(111111,99999);
    var randAccountNumber = getRandomNumberInString(11111111,999999);
    var randomAccountNumber = getRandomNumberInString(11111111,999999);
    var randCardNumber = getRandomNumberInString(111111111111111,99999999999999);
    var randomCardNumber = getRandomNumberInString(111111111111111,99999999999999);
    ...
    values('Savings Pot',now(),4,@Customer_ID,0.00,'${randSortCode}','${randAccountNumber}',${randCardNumber},'${randSecurityNumber}',date_add(now(), interval 6 year));

    Insert into Bank_Accounts(account_name, date_opened, account_type_id, customer_id, current_balance, sort_code, account_number, card_number, cvv_number, expiry_date)
    values('Student Account',now(),1,@Customer_ID,100.00,'${randomSortCode}','${randomAccountNumber}',${randomCardNumber},'${randomSecurityNumber}',date_add(now(), interval 3 year));
